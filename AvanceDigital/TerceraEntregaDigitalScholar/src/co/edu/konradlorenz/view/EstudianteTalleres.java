 ...
 * @author Usuario
 */
public class EstudianteTalleres extends javax.swing.JFrame {

    /**
     * Creates new form EstudianteTalleres
     */
    public EstudianteTalleres() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        ETalleres.setBackground(new java.awt.Color(153, 153, 153));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EstudianteTalleres.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EstudianteTalleres().setVisible(true);
            }
        });
    }
